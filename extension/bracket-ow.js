module.exports = function (nodecg) {
    ...
    const defaultBracket = {name: 'Bracket', items: [defaultBracktItem, defaultBracktItem, defaultBracktItem, defaultBracktItem, defaultBracktItem, defaultBracktItem, defaultBracktItem, defaultBracktItem]}
